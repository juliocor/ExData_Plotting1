...
## Plot 
    ...
    par(mfrow=c(2,2), mar=c(4,4,2,1), oma=c(0,0,2,0))    
        ...
        # plot 2
            plot(work_dataset$Datetime, work_dataset$Voltage,  type = "l", xlab = "datetime", ylab = "Voltage"  )
        ...
        # plot 4
            plot(work_dataset$Datetime, work_dataset$Global_reactive_power,  type = "l", xlab = "datetime", ylab = "Global Reactive Power"  )
